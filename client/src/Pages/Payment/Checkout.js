...
const Checkout = () => {
  ...
  const [btncol, setbtncol] = useState(true);
      ...
      >
        ...
        <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
          ...
          <button
            type="submit"
            disabled={btncol}
            className={`${btncol ? 'disabled:opacity-[0.45] cursor-wait' : 'hover:bg-yellow-600'} bg-yellow-500  transition-all ease-in-out duration-300 absolute bottom-0 w-full text-center py-2 text-xl font-bold rounded-bl-lg rounded-br-lg`}
          >
            Buy Now
          </button>
        </div>
